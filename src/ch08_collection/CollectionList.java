...
public class CollectionList {
   ...
   public static void main(String[] args) {
      /*
       *  컬렉션 프레임워크는 데이터를 보다 쉽게 다룰 수 있도록 재사용 재사용 가능한 컬렉션 클래스를 제공함.
       *  List, Set, Map
       ...
       *         대표 : HashMap, TreeMap */
          ...
          // ArrayList<String> students = new ArrayList<String>(); 오른쪾은 생략가능
          //<> <-- 이부분은 제네릭(Generic)이라고함.
          //        코드에서 타입의 안정성을 보정할 수 있으면 불필요한 캐스팅을 줄이기위해. 
